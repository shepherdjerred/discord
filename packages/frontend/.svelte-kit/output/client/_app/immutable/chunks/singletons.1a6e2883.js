import { H as d, s as E } from "./index.019f7634.js";
const c = [];
function p(e, t = d) {
  let n;
  const o = new Set();
...
var g;
const m = ((g = globalThis.__sveltekit_1k47lzz) == null ? void 0 : g.base) ?? "";
var k;
const w = ((k = globalThis.__sveltekit_1k47lzz) == null ? void 0 : k.assets) ?? m,
  A = "1680470468693",
...
function R() {
  ...
  async function o() {
    clearTimeout(n);
    const l = await fetch(`${w}/_app/version.json`, { headers: { pragma: "no-cache", "cache-control": "no-cache" } });
    if (l.ok) {
...
export { x as I, _ as P, y as S, I as a, L as b, N as c, O as d, m as e, U as f, z as g, V as h, S as i, P as s };
